...
for z0 in range(0):#['0p05', '0p1', '0p35', '0p7', '1p4']:
    ...
    np.save(f'data_zeta_components_hcv250/entrainment_term_DS1_20_{z0}.npy', top_rey)
    np.save(f'data_zeta_components_hcv250/advection_term_DS1_20_{z0}.npy', adv)
    np.save(f'data_zeta_components_hcv250/pgf_term_DS1_20_{z0}.npy', pgf)
    np.save(f'data_zeta_components_hcv250/acceleration_term_DS1_20_{z0}.npy', time)
    np.save(f'data_zeta_components_hcv250/coriolis_term_DS1_20_{z0}.npy', coriolis)